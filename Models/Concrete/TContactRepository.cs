...
namespace ContactsCoreMVC.Models.Concrete
{
  public class TContactRepository : IContactRepository
  {
    ...
    {
      TableOperation retriveOperation = TableOperation.Retrieve<ContactTable>(partitionKey, rowKey);
      TableResult tableResult = await _cloudTable.ExecuteAsync(retriveOperation);
    ...
    {
      TableOperation retriveOperation = TableOperation.Retrieve<ContactTable>
    ...
    public async Task DeleteAsync(string partitionKey, string rowKey)
    {
      ...
      if(contactToDelete != null){
        ...
        var result = await _cloudTable.ExecuteAsync(deleteContact);
